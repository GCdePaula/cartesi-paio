...
mod tests {
    ...
    #[test]
    fn test_sig() {
        use alloy_core::primitives::Signature;

        // replicating from metamask example...
        ...
        let domain: Eip712Domain = eip712_domain!(
              ...
              version: "1",
              chain_id: 1,
              verifying_contract: Address::from_hex("0xCcCCccccCCCCcCCCCCCcCcCccCcCCCcCcccccccC").unwrap(),
        );
        ...
        let message = Mail {
            from: Person {
                name: "Cow".to_string(),
                wallet: Address::from_hex("0xCD2a3d9F938E13CD947Ec05AbC7FE734Df8DD826").unwrap(),
            },
            to: Person {
                name: "Bob".to_string(),
                wallet: Address::from_hex("0xbBbBBBBbbBBBbbbBbbBbbbbBBbBbbbbBbBbbBBbB").unwrap(),
            },
        ...
        // signature generated by running metamask
        let address = Address::from_hex("0x5c43e6Ebb2854CE597A821979133B21aeb7EB493").unwrap();
        let raw_sig = "0x8def2799c7c0484b3d58217970ef495c9f064b253d349e86351a91d63d585e844a4a3c9d4763bc0d52b52827429e1d273fa9ddcce03ae4eb4430dfa61716a7d51b";

        // example code
        let sig = Signature::from_str(raw_sig).unwrap();
        assert_eq!(
